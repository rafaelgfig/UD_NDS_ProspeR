...
```{r Boxplot ListingCategory..numeric. por LoanOriginalAmount, echo=FALSE, message=FALSE, warning=FALSE, fig.height=6, fig.width=12}
# Boxplot das categorias declaradas pelo valor do empréstimo
ggplot(dff, aes(x = reorder(ListingCategory..numeric., LoanOriginalAmount, function(x) -median(x)), y = LoanOriginalAmount)) +
  geom_boxplot() +
