...
#  scale_y_log10() +
  coord_flip()
```
<br/>A grande maioria não declarou uma ocupação ou declarou apenas como ocupação profissional, não sendo possível afirmar corretamente qual a ocupação mais comum. Das ocupações declaradas o programador de computador ficou em destaque.
...
Foi verificado anteiormente que o valor mais solicitado é de 4.000 e a duração mais popular também é a de 36 meses, justificando a concentração anormal do valor da parcela com essa taxa de júros.
