...
ggplot(dff, aes(x = Term, y = LoanOriginalAmount)) +
  geom_boxplot()
```
<br/> Por último um boxplot da quantidade de parcelas com o valor solicitado, só para ter certeza que mais parcelas são para os empréstimos maiores e o inverso para empréstimos menores.
